...
DJLookAndFeel::DJLookAndFeel() = default;

DJLookAndFeel::DJLookAndFeel(juce::Colour colour) : colour(colour) {}

// I got reference from https://docs.juce.com/master/tutorial_look_and_feel_customisation.html
void DJLookAndFeel::drawRotarySlider(juce::Graphics& g, int x, int y, int width, int height, float sliderPos,
    ...
    // fill
    g.setColour(juce::Colour::fromRGB(0, 0, 139));
...
void DJLookAndFeel::drawButtonBackground(juce::Graphics& g, juce::Button& button, const juce::Colour& backgroundColour, bool, bool isButtonDown) {
...
// Taken from https://docs.juce.com/master/tutorial_look_and_feel_customisation.html
void DJLookAndFeel::drawButtonText(juce::Graphics& g, juce::TextButton& button, bool, bool isButtonDown) {
...
void DJLookAndFeel::drawLinearSlider(juce::Graphics& g, int x, int y, int width, int height, float sliderPos,
    ...
    if (style == juce::Slider::SliderStyle::LinearBarVertical) {
        g.fillAll(juce::Colour::fromRGB(0, 0, 139));
